...
import fatymaImg from '../assets/management/fatyma.png';
...
const players = [
    ...
    },
    {
        ...
        image: fatymaImg,
        imageClass: 'scale-[1.5] translate-y-2', // Zoomed in
        achievements: {
            wins: [
                { year: "2025-Present", name: "Patronum Esports Designer Intern", rank: "Intern" },
            ],
            runnerUps: [],
            notable: [
                { year: "2022-2026", name: "BS Artificial Intelligence", rank: "Student" },
            ]
        },
        stats: {
            yearsActive: "2+",
        ...
        bio: {
            gamingTag: "Fatyma",
            startedPlaying: "2024",
            rank: "Designer Intern",
            location: "Pakistan",
            born: "N/A",
            influence: "Design"
        },
        socials: {
            instagram: { value: "ig", sub: "Instagram", link: "https://www.instagram.com/fatymatales/" },
            linkedin: { value: "in", sub: "LinkedIn", link: "https://pk.linkedin.com/in/fatima-binte-bilal-129799262" },
        },
        characters: [],
        heroTitle: {
        ...
        highlight: {
            title: "Creative Designer & AI Enthusiast",
            description: <>Graphic Designer Intern at Patronum Esports with a strong passion for creative visual storytelling. Currently pursuing a BS in Artificial Intelligence (2022-2026). Extensive experience in design using Photoshop. actively engaged in the gaming community, playing Mobile Legends and various PC games.</>
        },
        sponsorships: [
            { year: "Jan 2025-Present", name: "Patronum Esports", fullName: "Graphic Designer Intern", description: "creating visual assets and contributed to the brand's aesthetic. Combining design skills with AI knowledge to create unique visuals." },
        ],
        skills: [
            "Graphic Design",
            "Adobe Photoshop",
